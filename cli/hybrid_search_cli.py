...
def main() -> None:
    ...
    rrf_search_subparser.add_argument("--rerank-method", type=str, choices = ["individual", "batch", "cross_encoder"], help= "Reranking of results")
    rrf_search_subparser.add_argument("--evaluate", action= argparse.BooleanOptionalAction, help= "Evaluates the results returned by the RRF search with a LLM")
